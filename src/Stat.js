...
export default class Stat {
  ...
  static getPrintableFormulaStatKeyList = (statList = [], modifiers = {}) => {
    ...
    return [...formulaKeys, ...modifiersKeys].filter((key) => statList.includes(key))
  }
...
FormulaText["enemyLevel_multi"] = (o) => <span>( 100 + {f(o, "characterLevel")}) / ( 100 + {f(o, "enemyLevel")} + 100 + {f(o, "characterLevel")})</span>
...
Object.entries(hitElements).forEach(([ele, {name: eleName}]) => {
  Object.entries(hitTypes).forEach(([type, typeName]) => {
    FormulaText[`${ele}_${type}`] = (o) => <span>{f(o, `finalATK`)} * {f(o, `${ele}_${type}_multi`)}</span>
  })
})
