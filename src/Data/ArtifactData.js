...
const ArtifactMainSlotKeys = [
  "hp", "hp_", "atk", "atk_", "def", "def_", "ele_mas", "ener_rech_", "crit_rate_", "crit_dmg_", "heal_", "physical_ele_dmg_",
]
Object.keys(ElementalData).forEach(key => ArtifactMainSlotKeys.push(`${key}_ele_dmg_`))
...
const ArtifactMainStatsData = {
  1: {
    ...
    physical_ele_dmg_: [3.9, 5.4, 6.9, 8.4, 9.9],
  ...
  2: {
    ...
    physical_ele_dmg_: [5.2, 6.7, 8.2, 9.7, 11.2, 12.7, 14.2, 15.6, 17.1],
  ...
  3: {
    ...
    physical_ele_dmg_: [6.6, 8.4, 10.3, 12.1, 14.0, 15.8, 17.7, 19.6, 21.4, 23.3, 25.1, 27.0, 28.8],
  ...
  4: {
    ...
    physical_ele_dmg_: [7.9, 10.1, 12.3, 14.6, 16.8, 19.0, 21.2, 23.5, 25.7, 27.9, 30.2, 32.4, 34.6, 36.8, 39.1, 41.3, 43.5],
  ...
  5: {
    ...
    physical_ele_dmg_: [8.7, 11.2, 13.7, 16.2, 18.6, 21.1, 23.6, 26.1, 28.6, 31, 33.5, 36, 38.5, 40.9, 43.4, 45.9, 48.4, 50.8, 53.3, 55.8, 58.3],
...
const ArtifactSlotsData = {
  ...
  goblet: { name: "Goblet of Eonothem", stats: ["hp_", "def_", "atk_", "ele_mas", "physical_ele_dmg_", "anemo_ele_dmg_", "geo_ele_dmg_", "electro_ele_dmg_", "hydro_ele_dmg_", "pyro_ele_dmg_", "cryo_ele_dmg_",] },
