...
let char = {
  ...
  baseStat: {
    character_hp: [1020, 2646, 3521, 5268, 5889, 6776, 7604, 8500, 9121, 10025, 10647, 11561, 12182, 13103],
    character_atk: [23, 61, 81, 121, 135, 156, 175, 195, 210, 231, 245, 266, 280, 301],
    character_def: [63, 165, 219, 328, 366, 421, 473, 528, 567, 623, 662, 719, 757, 815]
  },
  specializeStat: {
    key: "hydro_dmg_",
    ...
    auto: {
      ...
      charged: {
        ...
        fields: [{
          ...
          finalVal: (tlvl, stats) => (charged_final_atk[tlvl] / 100) * stats.physical_charged_avghit
        }, {
          text: `Stamina Cost`,
          value: `40/s`,
        }, {
