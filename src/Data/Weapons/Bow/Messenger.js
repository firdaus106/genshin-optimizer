...
const weapon = {
  ...
  passiveDescription: (refineIndex, charFinalStats) => <span>Charged Attack hits on weak points deal an additional {refinementVals[refineIndex]}% ATK DMG as CRIT DMG{DisplayPercent(refinementVals[refineIndex], charFinalStats, "phy_ele_crit_dmg")}. Can only occur once every 10s.</span>,
