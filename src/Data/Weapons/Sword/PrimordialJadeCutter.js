...
const weapon = {
  ...
  passiveDescription: (refineIndex, charFinalStats) => <span>HP increased by {refinementVals_hp[refineIndex]}%. Additionally, provides an ATK Bonus based on {refinementVals_hp_Atk[refineIndex]}% of the wielder's Max HP{DisplayPercent(refinementVals_hp_Atk[refineIndex], charFinalStats, "final_hp")}.</span>,
  ...
  stats: (refineIndex) => ({
    ...
    modifiers: { final_atk: { final_hp: refinementVals_hp_Atk[refineIndex] / 100 } }
  })
}
